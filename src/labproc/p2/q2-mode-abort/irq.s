...
_Reset:
	...
	MRS r0, cpsr
	BIC r0, r0, #0xF 		@ Zera os 4 bits menos significativos
	ORR r0, r0, #0x7 		@ Seta os 4 bits menos significativos para 0111 resultando em 0b10111 (Modo abort)
	BIC r0, r0, #0x80 		@ Ativa as interrupções para o processo
	STR r0, [r1, #64] 		@ mem[_linhaB + 15] = r0 = CPSR Abort
    ...
    ADD r3, r3, #0x1000
    MOV sp, r3 	@ pilha do abort definida
    MSR cpsr, r1 @ volta para o modo anterior
