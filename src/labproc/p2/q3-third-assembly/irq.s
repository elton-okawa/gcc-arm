...
_Reset:
	...
	ADD r3, r3, #0x1000
	LDR r1, _linhaC	
	STR r3, [r1, #52]		@ mem[_linhaC + 12] = r0 = SP processo C

	LDR r0, =processC
	STR r0, [r1, #60] 		@ mem[_linhaC + 14] = r0 = PC processo C

	MRS r0, cpsr
	BIC r0, r0, #0x80 		@ Ativa as interrupções para o processo
	STR r0, [r1, #64] 		@ mem[_linhaB + 15] = r0 = CPSR SUPERVISOR
	@ end processes
...
do_irq_interrupt: @ Rotina de interrupções IRQ
	...
	CMP 	r0, #2
	LDREQ 	r0, =linhaC 		@ r0 = &mem[_linhaC]
	@ end verificacao
