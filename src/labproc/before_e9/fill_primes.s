...
main:
        ADR     r3, array_primes
        LDR     r1, =2                @ r1 = numero sendo testado
        LDR     r2, =30                 @ r2 = numero de primos requeridos
...
loop_fill:
        ...
        STREQ   r1, [r3], #4            @ armazena r1 (número testado) na memória se for primo
        SUBEQ   r2, r2, #1              @ r2-- (número de primos requeridos)
        ADD     r1, r1, #1              @ r1++ (número testado)
        B       loop_fill
